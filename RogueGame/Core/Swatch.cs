...
namespace RogueGame.Core
{
    public class Swatch
    {
        ...
        public RLColor ComplimentLightest = new RLColor(190, 180, 174);
        public RLColor ComplimentLighter = new RLColor(158, 147, 138);
        public RLColor Compliment = new RLColor(129, 116, 107);
        public RLColor ComplimentDarker = new RLColor(97, 84, 75);
        public RLColor ComplimentDarkest = new RLColor(71, 56, 45);
        ...
        public static RLColor DbGrass = new RLColor(109, 170, 153);
        public static RLColor DbSkin = new RLColor(210, 170, 153);
        public static RLColor DbSky = new RLColor(109, 194, 202);
        public static RLColor DbSun = new RLColor(222, 238, 214);
